...
def make_joint(withdraw, old_password, new_password):
    ...
    """
    "*** YOUR CODE HERE ***"
    incorrect = withdraw(0, attempt) # why I can call withdraw here
...
def generate_paths(t, x):
    ...
    if label(t) == x:
        yield [label(t)]
    for b in branches(t):
        tempbranch = generate_paths(b, x)
        for next in tempbranch:
            yield [label(t)] + next # not quiet understand "yield"
